...
class EventOpenRequest extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            'field' => 'required',
            'opening_date' => 'required|after:-1 day',
            'start_at' => 'required',
            'end_at' => 'required|after:start_at',
            'capacity' => 'required|digits_between:1,2',
            'recruit_start_date' => 'required|after:-1 day',
            'recruit_end_date' => 'required|after:recruit_start_date',
            'recruit_start_time' => 'required',
            'recruit_end_time' => 'required'
        ];
    }
